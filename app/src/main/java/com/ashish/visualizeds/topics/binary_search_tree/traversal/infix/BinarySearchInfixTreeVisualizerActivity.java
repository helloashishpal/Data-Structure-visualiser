package com.ashish.visualizeds.topics.binary_search_tree.traversal.infix;
...
import com.ashish.visualizeds.databinding.ActivityBinarySearchTreeInfixVisualizerBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class BinarySearchInfixTreeVisualizerActivity extends AppCompatActivity {

    private ActivityBinarySearchTreeInfixVisualizerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBinarySearchTreeInfixVisualizerBinding.inflate(getLayoutInflater());
        ...
        binding.visualizeButton.setOnClickListener(v -> {
            ...
            infixHelper(finalRoot, finalRoot);
        });
    }
    ...
    private void infixHelper(BinaryTreeNode finalRoot, BinaryTreeNode root) {
        if (root == null) {
            //Generating Visuals
        ...
        //LEFT SUBTREE VISUAL + CALL
        {
            ...
            infixHelper(finalRoot, root.leftNode);
        }
        ...
        // NODE VISUAL + CALL
        {
            ...
            stepCardBuilder.getDataNodeHolder().addView(binarySearchTreeBuilder.generateBinarySearchTree(finalRoot, root.data));
            //Description
            stepCardBuilder.setCardDescription(String.format("We fully traversed the left subtree.\n%d is now added to the traversed list.\nCurrent list : %s \n\nNow we move to the right subtree.", root.data, arr.toString()));
            binding.holderLinearLayout.addView(stepCardBuilder.getStepCard());
        ...
        //RIGHT SUBTREE VISUAL + CALL
        {
            ...
            infixHelper(finalRoot, root.rightNode);
        }
    }
